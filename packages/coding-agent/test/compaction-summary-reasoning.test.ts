...
describe("generateSummary reasoning options", () => {
	...
	it("passes the caller's thinking level through for reasoning-capable models", async () => {
		// The session/setting resolution happens in the session; this layer only
		// applies the level it is given.
